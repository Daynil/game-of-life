...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.handleCellClick = function (e, coords) {
	        var clickedCell = this.state.gameState.board[coords.row][coords.col];
	        if (clickedCell == 0)
	            this.state.gameState.board[coords.row][coords.col] += 1;
	        else if (clickedCell == 1)
	            this.state.gameState.board[coords.row][coords.col] -= 1;
	        else if (clickedCell == 2)
	            this.state.gameState.board[coords.row][coords.col] = 0;
	        this.refreshState();
	    };
	    ...
	    App.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {id: "page-wrapper"}, React.createElement("h1", null, "ReactJS - Game of ", React.createElement("span", {id: "highlight"}, "Life")), React.createElement("h4", null, "Current Generation: ", this.state.gameState.currentGeneration), React.createElement(GameBoard, {columns: 70, rows: 50, game: this.state.gameState, handleCellClick: function (e, coords) { return _this.handleCellClick(e, coords); }}), React.createElement("div", {id: "controls"}, React.createElement("span", {className: "button", onClick: function (e) { return _this.game.run(); }}, "Run"), React.createElement("span", {className: "button", onClick: function (e) { return _this.game.step(); }}, "Step"), React.createElement("span", {className: "button", onClick: function (e) { return _this.game.pause(); }}, "Pause"), React.createElement("span", {className: "button", onClick: function (e) { return _this.clearBoard(); }}, "Clear")), React.createElement(Foot, null)));
	    };
	    return App;
	}(React.Component));
	var GameBoard = (function (_super) {
	    ...
	    GameBoard.prototype.getCellState = function (coords) {
	        var cellState = this.gameState.board[coords.row][coords.col];
	        var className = '';
	        if (cellState == 1)
	            className = 'young';
	        if (cellState == 2)
	    ...
	    GameBoard.prototype.getRow = function (rowNum, columns) {
	        var _this = this;
	        var row = [];
	        var _loop_1 = function(i) {
	            var cellCoords = { row: rowNum, col: i };
	            row.push(React.createElement("td", {className: this_1.getCellState(cellCoords), key: i, onClick: function (e) { return _this.props.handleCellClick(e, cellCoords); }}));
	        };
	        var this_1 = this;
	    ...
	    GameBoard.prototype.generateBoard = function () {
	        ...
	        for (var i = 0; i < rows; i++) {
	            tableContents.push(React.createElement("tr", {key: i}, this.getRow(i, columns)));
	        }
	        return React.createElement("table", null, React.createElement("tbody", null, tableContents));
	    };
	...
	var Game = (function () {
	    function Game(refreshState, colsRows) {
	        this.gameState = {
	            isActive: false,
	            currentGeneration: 0,
	            board: []
	    ...
	    Game.prototype.initBoard = function (colsRows, starter) {
	        ...
	        */
	        var board = [];
	        for (var row = 0; row < colsRows.rows; row++) {
	            var nextRow = [];
	            for (var col = 0; col < colsRows.cols; col++) {
	                var cellState = void 0;
	                if (starter == null)
	                    cellState = 0;
	                else if (starter == 'random')
	                    cellState = Math.floor(Math.random() * 3);
	    ...
	    Game.prototype.nextGeneration = function (stepping) {
	        if (!this.gameState.isActive) {
	            if (stepping == null || stepping == false)
	                return;
	        }
	        var originalBoard = this.gameState.board;
	        //let nextBoard = JSON.parse(JSON.stringify(this.gameState.board));
	        var nextBoard = this.gameState.board.map(function (row) { return row.slice(); });
	        for (var row = 0; row < originalBoard.length; row++) {
	            for (var col = 0; col < originalBoard[row].length; col++) {
	                var currentCell = { row: row, col: col };
	                var currentCellState = originalBoard[row][col];
	                var livingNeighbors = this.findCellNeighbors(currentCell);
	                // Living cells
	                if (currentCellState > 0) {
	                    ...
	                    if (livingNeighbors == 3)
	                        nextBoard[row][col] = 1; // Cell comes to life
	                }
	            }
	        }
	        if (!this.gameState.isActive) {
	    ...
	    Game.prototype.findCellNeighbors = function (cell) {
	        ...
	        for (var row = cell.row - 1; row <= cell.row + 1; row++) {
	            var rowToCheck = row;
	            if (row < 0)
	                rowToCheck = boardRows - 1;
	            else if (row > boardRows - 1)
	                rowToCheck = 0;
	            for (var col = cell.col - 1; col <= cell.col + 1; col++) {
	                var colToCheck = col;
	                if (col < 0)
	                    colToCheck = boardCols - 1;
	                else if (col > boardCols - 1)
	                    colToCheck = 0;
	                var cellToCheck = { row: rowToCheck, col: colToCheck };
	                var cellToCheckState = board[rowToCheck][colToCheck];
	                var isSelf = (cellToCheck.row == cell.row) && (cellToCheck.col == cell.col);
	                if (cellToCheckState > 0 && !isSelf)
	                    numLivingNeighbors++;
	            }
	        }
	...
	var Foot = (function (_super) {
	    ...
	    Foot.prototype.render = function () {
	        return (React.createElement("div", {id: "foot"}, React.createElement("div", {id: "foot-text"}, "Created by ", React.createElement("a", {href: "https://github.com/Daynil/"}, "Daynil"), " for ", React.createElement("a", {href: "http://www.freecodecamp.com/"}, "FCC"), React.createElement("br", null), React.createElement("a", {id: "gh-link", href: "https://github.com/Daynil/game-of-life"}, React.createElement("i", {className: "fa fa-github-square fa-lg"}), "Github repo"))));
	    };
	    return Foot;
	}(React.Component));
